...
import { AccessDeniedScopeIoError } from '../error/access-denied.scope.io.error'
...
import { ScopeIoHelper } from '../helper/scope.io.helper'
...
@SocketMiddleware('/managing')
export class AdminScopeIoMiddleware implements MiddlewareInterface {
